...
- **프로젝트 설명 영상 팝업 & 노출 제어**: 첫 접속 시 시스템 파이프라인 소개 영상 팝업 노출, "자세히 보기" 시 소개 탭 즉시 전환, 1일/7일/30일 만료 기반 팝업 다시 보지 않기(localStorage) 제어.
...
└── js/
    ...
    └── modules/
        ├── intro-modal.js      # 소개 영상 팝업 표시/만료(1·7·30일) 제어 모듈
